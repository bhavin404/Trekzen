...
const Footer = () => {
  return (
    <section id="footer" className='flexCenter mb-24 '>
      <div className="padding-container max-container flex w-full flex-col gap-14">
        ...
        <p className='regular-14 w-full text-center text-gray-30'>2023 trekzen all right reserved</p>
      </div>
...
type footerColumnProps ={
  ...
  //this line above here basically is whatever we send in inside the <FooterColumn>{basically here}</FooterColumn>
}
